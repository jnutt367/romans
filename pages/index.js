...
export default function Home() {
  return (
    <div className={styles.container}>
      <Head>
        <title>Paul's Letter to the Romans</title>
...
28 A person is not a Jew who is one only outwardly, nor is circumcision merely outward and physical. 29 No, a person is a Jew who is one inwardly; and circumcision is circumcision of the heart, by the Spirit, not by the written code. Such a person’s praise is not from other people, but from God.</p>
          </div>
          <div className={styles.card}
          >
...
25 Now to him who is able to establish you in accordance with my gospel, the message I proclaim about Jesus Christ, in keeping with the revelation of the mystery hidden for long ages past, 26 but now revealed and made known through the prophetic writings by the command of the eternal God, so that all the Gentiles might come to the obedience that comes from[f] faith— 27 to the only wise God be glory forever through Jesus Christ! Amen.
  ...
  <iframe width="100%" height="315" src="https://www.youtube.com/embed/0SVTl4Xa5fY?autoplay=1&mute=1" title="YouTube video player" frameborder="10" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
  </div>
...
<main id="james" className={styles.main}>
      ...
      JAMES 
          ...
          <div className={styles.iframe1}>
                         <iframe width="100%" height="300" src="https://www.youtube.com/embed/8oz1JK19_B0?si=J03p2Hn1D2FLkAge&autoplay=1&mute=1" title="YouTube video player" frameborder="10" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                        </div>
    <p className={styles.parables}>
...
<iframe width="100%" height="315" src="https://www.youtube.com/embed/qn-hLHWwRYY?aoutoplay=1&mute=1" title="YouTube video player" frameborder="1" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>                        
        ...
        <div className={styles.grid}>
          ...
          <div className={styles.card2}>
            <h2 className={styles.chapter2}>James Chapter II</h2>
            <p> 
          ...
          >
            <h2 className={styles.chapter2}>James Chapter III </h2>
            <p>
                   Taming the Tongue
          ...
          <div className={styles.card2}
          >
            <h2 className={styles.chapter2}>James Chapter V</h2>
            <p> Warning to Rich Oppressors
...
19 My brothers and sisters, if one of you should wander from the truth and someone should bring that person back, 20 remember this: Whoever turns a sinner from the error of their way will save them from death and cover over a multitude of sins.
          ...
          >
            ...
            I have appended James to the end of Romans ...
            I will be appending 1 Peter to the end of Galatians ... 
            I will be appending 2 Peter to the end of Ephesians ... 
            I will be appending 1 John to the end of Philippians ... 
            I will be appending 2 John to the end of Colossians ... 
            I will be appending 3 John to the end of 2 John... 
            I will be appending Jude to the end of the Revelation ... 
